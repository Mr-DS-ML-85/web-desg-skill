...
| [`proofs/proofs/minimax-m3-security_and_feature.md`](proofs/minimax-m3-security_and_feature.md) | MiniMax M3 | Independent scan of the same target — goes deepdive into security and architecture analysis
