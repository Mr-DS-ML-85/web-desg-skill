...
| [`proof/Minimax_M3_Moltbook.md`](proof/Minimax_M3_Moltbook.md) | MiniMax M3 | Independent scan of the same target — goes further into page-composition trees, working HTML for the clickable-card pattern, and a "what NOT to copy" IP-boundary section |
